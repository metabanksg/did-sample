...
if [[ "$1" == daemon ]];then
    ...
    java ${JAVA_OPTS} -cp dist/app/*:resources/:dist/lib/* com.metabank.weid.demo.command.DemoCommand $1 >/dev/null 2>&1 &
    ...
    echo "--------- start $1 ----------"
    java ${JAVA_OPTS} -cp dist/app/*:resources/:dist/lib/* com.metabank.weid.demo.command.DemoCommand $1
fi
