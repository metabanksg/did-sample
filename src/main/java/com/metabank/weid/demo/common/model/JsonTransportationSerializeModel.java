package com.metabank.weid.demo.common.model;
...
public class JsonTransportationSerializeModel {
    ...
    @ApiModelProperty(name = "presentationE", value = "待序列化对象", required = true,
        example = "{\n"
            + "    \"context\": [\n"
            + "      \"https://github.com/metabankFinTech/WeIdentity/blob/master/context/v1\"\n"
            + "    ],\n"
            + "    \"type\": [\n"
            ...
            + "      {\n"
            + "        \"context\": \"https://github.com/metabankFinTech/WeIdentity/blob/master/context/v1\",\n"
            ...
            + "        },\n"
            + "        \"proofType\": \"Secp256k1\",\n"
            + "        \"signatureThumbprint\": \"{\\\"claim\\\":\\\"{\\\"age\\\":\\\"0x98cf672409c25cf2f0149ceccd505e9c75a024273c5588bd88e0c8f362c01422\\\",\\\"gender\\\":\\\"0x8eb2b804a8f36f7257dc708f1629cd47b292566a00066cb76157591d45dcef92\\\",\\\"name\\\":\\\"0x0303a5b639ba700bec18eb9d8d9488a8a7d18371f95a14bd49209f3ddde60136\\\"}\\\",\\\"context\\\":\\\"https://github.com/metabankFinTech/WeIdentity/blob/master/context/v1\\\",\\\"cptId\\\":1001,\\\"expirationDate\\\":1578517027,\\\"id\\\":\\\"2cd5aced-a30a-4934-803d-fb0f090957a4\\\",\\\"issuanceDate\\\":1578466962,\\\"issuer\\\":\\\"did:weid:1:0x19607cf2bc4538b49847b43688acf3befc487a41\\\",\\\"proof\\\":null,\\\"type\\\":[\\\"VerifiableCredential\\\"]}\"\n"
            + "      }\n"
            + "    ],\n"
            + "    \"proof\": {\n"
            + "      \"created\": 1578471192,\n"
