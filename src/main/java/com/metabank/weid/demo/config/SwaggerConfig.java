package com.metabank.weid.demo.config;
...
public class SwaggerConfig {
    ...
    public Docket newsApi() {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .groupName("default")
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.metabank.weid.demo.controller"))
    ...
    public Docket otherRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .groupName("其他相关接口")
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.metabank.weid.demo.controller.other"))
            .paths(PathSelectors.any())
            .build();
    }*/
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
            ...
            //.contact(new Contact("weid docs","https://weidentity.readthedocs.io/zh_CN/latest/README.html","weidentity@metabank.com"))
            .termsOfServiceUrl(null)
            .license(null)
            //.licenseUrl("https://github.com/metabankFinTech/WeIdentity/blob/master/COPYING")
            //.license("Find out more about weid")
            //.licenseUrl("https://github.com/metabankFinTech/WeIdentity")
            .version(null)
