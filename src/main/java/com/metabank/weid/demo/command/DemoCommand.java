...
import com.metabank.weid.demo.service.impl.PolicyServiceImpl;
...
import com.metabank.weid.util.ScanCodeUtils;
...
public class DemoCommand extends DemoBase {
    ...
    private static void issuer() {
        ...
        // registered authority, "metabank" is the authority Name, "0" is default.
        demoService.registerAuthorityIssuer(createWeId, "metabank" + System.currentTimeMillis(), "0");
    ...
    private static void userAgent() {
        ...
        String url = "https://github.com/metabankFinTech/WeIdentity";
