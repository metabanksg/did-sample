...
public class BaseBean {
    ...
    private static void printBean(String blank, Object obj, StringBuilder beanStr) {
        if (isSimpleValueType(obj)) {
            beanStr.append(blank)
                ...
                .append(com.metabank.weid.demo.command.BeanConstant.LINE_CHARAC);
            return;
        }
        ...
        if ((obj instanceof String[])) {
            ...
            for (int i = 0; i < a.length; i++) {
                beanStr.append(com.metabank.weid.demo.command.BeanConstant.LEFT_MID_BRACKETS)
                    .append(i)
                    .append(com.metabank.weid.demo.command.BeanConstant.RIGHT_MID_BRACKETS)
                    .append(com.metabank.weid.demo.command.BeanConstant.COLON_CHARAC)
                    .append(com.metabank.weid.demo.command.BeanConstant.BLANK_SPACE)
                    .append(a[i])
                    .append(com.metabank.weid.demo.command.BeanConstant.LINE_CHARAC);
            }
        }
    ...
    private static void printCollection(String blank, Collection<?> c,StringBuilder beanStr) {
        ...
        while (it.hasNext()) {
            ...
            if (obj == null) {
                beanStr.append(blank)
                    .append(com.metabank.weid.demo.command.BeanConstant.LEFT_MID_BRACKETS)
                    .append(i++)
                    .append(com.metabank.weid.demo.command.BeanConstant.RIGHT_MID_BRACKETS)
                    .append(com.metabank.weid.demo.command.BeanConstant.COLON_CHARAC)
                    .append(com.metabank.weid.demo.command.BeanConstant.BLANK_STR)
                    .append(com.metabank.weid.demo.command.BeanConstant.LINE_CHARAC);
                continue;
            }
            if (isSimpleValueType(obj)) {
    ...
    private static void printByType(
        ...
        if (isSimpleValueType(right)) {
            ...
            beanStr.append(blank)
                .append(String.valueOf(leftObj))
                .append(com.metabank.weid.demo.command.BeanConstant.COLON_CHARAC)
                .append(com.metabank.weid.demo.command.BeanConstant.LEFT_BRACKETS)
                .append(clazz.getName())
                .append(com.metabank.weid.demo.command.BeanConstant.RIGHT_BRACKETS)
                .append(com.metabank.weid.demo.command.BeanConstant.LINE_CHARAC);
